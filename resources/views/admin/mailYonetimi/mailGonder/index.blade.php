		...
		<div class="container-fluid">
			...
			<div class="row">
				...
				<div class="col-xl-12">
					<div class="card">
						<div class="card-body"> 
							<a href="{{route('admin.mailGonder.olustur.sayfa')}}"><span class="btn btn-primary btn btn-xl inputTwo" style="margin-bottom: 20px">Yeni Mail Gönder</span></span></a>
							<span class="float-right text-muted font-size-13"></span>
							<h5 class="card-title mb-3">Gönderilmiş Mailler</h5>
							<p class="card-title-desc">
								Gönderilmiş maillere bu sayfadan ulaşabilirsiniz.
							</p>
