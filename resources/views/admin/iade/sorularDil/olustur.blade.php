				...
				<div class="col-12">
					<div class="card">
						<div class="card-body">
							...
							<h4 class="card-title">Soru Dili Oluştur</h4>
							<p class="card-title-desc">Soru dilini oluşturunuz.</p>

							<div class="row">

								<div class="col-lg-12 col-sm-12 mb-4">
									<form action="{{ route('admin.iade.sorularDil.olustur', $soru['id']) }}" method="post" enctype="multipart/form-data">
										@csrf
										...
										<div class="form-group ">
											<label for="example-email-input1" class="col-form-label pt-0">Soru <span style="color: red;">*</span></label>
											<input class="form-control" name="aciklama" type="text" id="example-email-input1" placeholder="Slider başlığını giriniz" required="true" value="{{ old('aciklama') }}">
										</div>  
