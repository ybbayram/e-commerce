			...
			<div class="row">
				<div class="col-12">
					<div class="page-title-box d-flex align-items-center justify-content-between">
						<h4 class="mb-0 font-size-18">Ülke Güncelle</h4>
					</div>
				</div>
			</div>
				...
				<div class="col-12">
					<div class="card">
						<div class="card-body">
							...
							<h4 class="card-title">Ülke Güncelle</h4>
							<p class="card-title-desc">Ülke güncelleyiniz.</p>

							<div class="row">

								<div class="col-lg-12 col-sm-12 mb-4">
									<form action="{{ route('admin.ulke.guncelle', $ulke->id) }}" method="post">
										@csrf
										...
										<div class="form-group" id="example-email-input1">
											...
											<select class="form-control" name="para_birimi_id">
												...
												@if($entry->id == $ulke->para_birimi_id)
												<option value="{{ $entry->id }}" checked="true">{{ $entry->ad }}</option>
												@endif
												@endforeach
												@foreach($paraBirimleri as $entry)
