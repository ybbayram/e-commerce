		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-12">
					<div class="page-title-box d-flex align-items-center justify-content-between">
						<h4 class="mb-0 font-size-18">Ülkeler</h4>
					</div>
				</div>
			</div>
			<!-- end page title -->
			...
			<div class="row">
				...
				<div class="col-xl-12">
					<div class="card">
						<div class="card-body">
							<a href="{{ route('admin.ulke.olustur.sayfa') }}"><span class="btn btn-primary btn btn-xl inputTwo" style="margin-bottom: 20px">Yeni Ülke</span></span></a>
							<span class="float-right text-muted font-size-13"></span>
							<h5 class="card-title mb-3">Ülkeler</h5>
							<p class="card-title-desc">
								Ülkelere bu sayfadan ulaşabilirsiniz.
							</p>
								...
								<div class="table-responsive">
									<table id="datatable-buttons" class="table table-striped table-bordered w-100">
										...
										<tbody>
											...
											<tr>
												<td>{{ $entry->ulke_kod_getir['ad'] }}</td>
												<td>{{ $entry->para_birimi_getir['ad'] }} - {{ $entry->para_birimi_getir['simge'] }}</td>
												<td>{{ $entry['created_at'] }}</td>					
												<td>
													<a href="{{ route('admin.ulke.guncelle.sayfa', $entry->id) }}" class="btn btn-primary waves-effect waves-light"><i class="dripicons-pencil"></i></a>
														...
														<div class="modal-dialog modal-dialog-centered">
															<div class="modal-content">
																...
																<div class="modal-body">
																	<form action="{{ route('admin.ulke.sil', $entry->id) }}" method="get">
																		@csrf
