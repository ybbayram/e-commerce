		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-12">
					<div class="page-title-box d-flex align-items-center justify-content-between">
						<h4 class="mb-0 font-size-18">Filtreler</h4>
					</div>
				</div>
			</div>
			<!-- end page title -->
			...
			<div class="row">
				...
				<div class="col-xl-12">
					<div class="card">
						<div class="card-body">
							<a href="{{ route('admin.filtre.olustur.sayfa') }}"><span class="btn btn-primary btn btn-xl inputTwo" style="margin-bottom: 20px">Yeni Filtre</span></span></a>
							<a href="{{ route('admin.filtre.sirala.sayfa') }}"><span class="btn btn-primary btn btn-xl inputTwo" style="margin-bottom: 20px">Sırala</span></span></a>
							<span class="float-right text-muted font-size-13"></span>
							<h5 class="card-title mb-3">Filtreler</h5>
							<p class="card-title-desc">
								Filtrelere bu sayfadan ulaşabilirsiniz.
							</p>
									...
									<table id="datatable-buttons" class="table table-striped table-bordered w-100">
										...
										<tbody>
											...
											<tr>
												...
												<td>
													<a href="{{ route('admin.filtre.guncelle.sayfa', $entry->id) }}" title="Düzenle" data-tippy-placement="top" class="btn btn-primary waves-effect waves-light tippy-btn"><i class="dripicons-pencil"></i></a>
													<a href="{{ route('admin.filtreDil', $entry->id) }}" title="Dil"  class="btn btn-primary waves-effect waves-light tippy-btn"><i class="dripicons-flag"></i></a> 
													@if($entry->durum == 0)
													<a href="{{ route('admin.filtre.aktifYap', $entry->id) }}" class="btn btn-danger waves-effect waves-light">Aktif Yap</a>
													@else
													<a href="{{ route('admin.filtre.pasifYap', $entry->id) }}" class="btn btn-success waves-effect waves-light">Pasif Yap</a>
													@endif
														...
														<div class="modal-dialog modal-dialog-centered">
															<div class="modal-content">
																...
																<div class="modal-body">
																	<form action="{{ route('admin.filtre.sil', $entry->id) }}" method="get">
																		@csrf
