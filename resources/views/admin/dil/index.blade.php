		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-12">
					<div class="page-title-box d-flex align-items-center justify-content-between">
						<h4 class="mb-0 font-size-18">Diller</h4>
					</div>
				</div>
			</div>
			<!-- end page title -->
			...
			<div class="row">
				...
				<div class="col-xl-12">
					<div class="card">
						<div class="card-body">
							<a href="{{ route('admin.dil.olustur.sayfa') }}"><span class="btn btn-primary btn btn-xl inputTwo" style="margin-bottom: 20px">Yeni Dil</span></span></a>
							<span class="float-right text-muted font-size-13"></span>
							<h5 class="card-title mb-3">Diller</h5>
							<p class="card-title-desc">
								Dillere bu sayfadan ulaşabilirsiniz.
							</p>
								...
								<div class="table-responsive">
									<table id="datatable-buttons" class="table table-striped table-bordered w-100">
										...
										<tbody>
											...
											<tr>
												<td>{{ $entry['ad'] }}</td>
												<td>{{ $entry['gorunur_ad'] }}</td>
												<td>{{ $entry['created_at'] }}</td>
												<td>
													<a href="{{ route('admin.dil.guncelle.sayfa', $entry->id) }}" class="btn btn-primary waves-effect waves-light"><i class="dripicons-pencil"></i></a>
													@if($entry->durum == 0)
													<a href="{{ route('admin.dil.aktifYap', $entry->id) }}" class="btn btn-danger waves-effect waves-light">Aktif Yap</a>
													@else
													<a href="{{ route('admin.dil.pasifYap', $entry->id) }}" class="btn btn-success waves-effect waves-light">Pasif Yap</a>
													@endif
														...
														<div class="modal-dialog modal-dialog-centered">
															<div class="modal-content">
																...
																<div class="modal-body">
																	<form action="{{ route('admin.dil.sil', $entry->id) }}" method="get">
																		@csrf
