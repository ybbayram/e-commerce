			...
			<div class="row">
				<div class="col-12">
					<div class="page-title-box d-flex align-items-center justify-content-between">
						<h4 class="mb-0 font-size-18">Dil Oluştur</h4>
					</div>
				</div>
			</div>
				...
				<div class="col-12">
					<div class="card">
						<div class="card-body">
							...
							<h4 class="card-title">Dil Oluştur</h4>
							<p class="card-title-desc">Dil oluşturunuz.</p>

							<div class="row">

								<div class="col-lg-12 col-sm-12 mb-4">
									<form action="{{ route('admin.dil.olustur') }}" method="post">
										@csrf
										<div class="form-group ">
											<label for="example-email-input1" class="col-form-label pt-0">Ad <span style="color: red;">*</span></label>
											<input class="form-control" name="ad" type="text" id="example-email-input1" placeholder="Dil adını giriniz" required="true" value="{{ old('ad') }}">
										</div>
										<div class="form-group ">
											<label for="example-email-input1" class="col-form-label pt-0">Görünür Ad <span style="color: red;">*</span></label>
											<input class="form-control" name="gorunurAd" type="text" id="example-email-input1" placeholder="Dilin görünür adını giriniz" required="true" value="{{ old('gorunurAd') }}">
										</div>
										...
										<div class="form-group ">
											...
											<textarea name="json" rows="6" class="form-control">{{ old('json') }}</textarea>
										</div>
