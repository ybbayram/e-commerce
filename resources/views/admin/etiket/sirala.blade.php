			...
			<div class="row">
				<div class="col-12">
					<div class="page-title-box d-flex align-items-center justify-content-between">
						<h4 class="mb-0 font-size-18">Etiket Sırala</h4>
					</div>
				</div>
			</div>
			<!-- end page title -->
				...
				<div class="col-xl-12">
					<div class="card">
						<div class="card-body">
							...
							<h5 class="card-title mb-3">Etiket Sırala</h5>
							<p class="card-title-desc">
								Etiketleri bu sayfadan sıralayabilirsiniz.
							</p>
							...
							<form action="{{ route('admin.etiket.sirala') }}" method="post">
								@csrf
