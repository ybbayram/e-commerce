			...
			<div class="row">
				<div class="col-12">
					<div class="page-title-box d-flex align-items-center justify-content-between">
						<h4 class="mb-0 font-size-18">{{ $filtre['ad'] }} Filtre Dili Oluştur</h4>
					</div>
				</div>
			</div>
				...
				<div class="col-12">
					<div class="card">
						<div class="card-body">
							...
							<h4 class="card-title">Filtre Dili Oluştur</h4>
							<p class="card-title-desc">Filtre dili oluşturunuz.</p>

							<div class="row">

								<div class="col-lg-12 col-sm-12 mb-4">
									<form action="{{ route('admin.filtreDil.olustur', $filtre['id']) }}" method="post">
										@csrf
										...
										<div class="form-group ">
											...
											<input class="form-control" name="ad" type="text" id="example-email-input1" placeholder="Filtre dili adını giriniz" required="true" value="{{ old('ad') }}">
										</div>
