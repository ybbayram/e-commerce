			...
			<div class="row">
				<div class="col-12">
					<div class="page-title-box d-flex align-items-center justify-content-between">
						<h4 class="mb-0 font-size-18">{{ $etiket['ad'] }} Etiket Dili Oluştur</h4>
					</div>
				</div>
			</div>
				...
				<div class="col-12">
					<div class="card">
						<div class="card-body">
							...
							<h4 class="card-title">Etiket Dili Oluştur</h4>
							<p class="card-title-desc">Etiket dili oluşturunuz.</p>

							<div class="row">

								<div class="col-lg-12 col-sm-12 mb-4">
									<form action="{{ route('admin.etiketDil.olustur', $etiket['id']) }}" method="post">
										@csrf
										...
										<div class="form-group ">
											...
											<input class="form-control" name="ad" type="text" id="example-email-input1" placeholder="Etiket dili adını giriniz" required="true" value="{{ old('ad') }}">
										</div>
