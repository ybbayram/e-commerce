			...
			<div class="row">
				<div class="col-12">
					<div class="page-title-box d-flex align-items-center justify-content-between">
						<h4 class="mb-0 font-size-18"><b>{{ $urun['baslik'] }}</b> Ürünü Görselleri</h4>
					</div>
				</div>
			</div>
			<!-- end page title -->
				...
				<div class="col-xl-12">
					<div class="card">
						<div class="card-body">
							...
							<a href="{{ route('admin.urunGorsel.olustur.sayfa', $urun['id']) }}"><span class="btn btn-primary btn btn-xl inputTwo" style="margin-bottom: 20px">Yeni Ürün Görseli</span></span></a>
							<a href="{{ route('admin.urunGorsel.sirala.sayfa', $urun['id']) }}"><span class="btn btn-primary btn btn-xl inputTwo" style="margin-bottom: 20px">Sırala</span></span></a>
							<span class="float-right text-muted font-size-13"></span>
							<h5 class="card-title mb-3">Ürün Görselleri</h5>
							<p class="card-title-desc">
								Ürün görsellerine bu sayfadan ulaşabilirsiniz.
							</p>
							...
							<div class="card-body">
								...
								<div class="table-responsive">
									<table class="table mb-0" id="datatable2">
										...
										<tbody>
											@foreach($urunGorsel as $entry)
											<tr>
												<td><img src="{{ $entry->gorsel }}" height="200"></td>
														...
														<div class="modal-dialog modal-dialog-centered">
															<div class="modal-content">
																...
																<div class="modal-body">
																	<form action="{{ route('admin.urunGorsel.sil', $entry->id) }}" method="get">
																		@csrf
