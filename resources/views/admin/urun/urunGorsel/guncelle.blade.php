								...
								<div class="col-lg-12 col-sm-12 mb-4">
									<form action="{{ route('admin.urunDetay.guncelle', $urunDetay->id) }}" method="post">
										...
										<div class="form-group" id="example-email-input1">
											...
											<textarea class="form-control" name="aciklama_bir">{{ old('aciklama_bir', $urunDetay->aciklama_bir) }}</textarea>
										</div>
										<div class="form-group" id="example-email-input1">
											<label for="example-email-input1" class="col-form-label pt-0">Açıklama İki <span style="color: red;">*</span></label>
											<textarea id="elm1" name="aciklama_iki">{{ old('aciklama_iki', $urunDetay->aciklama_iki) }}</textarea>
										</div>
