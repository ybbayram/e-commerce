			...
			<div class="row">
				<div class="col-12">
					<div class="page-title-box d-flex align-items-center justify-content-between">
						<h4 class="mb-0 font-size-18">Görsel Sırala</h4>
					</div>
				</div>
			</div>
			<!-- end page title -->
				...
				<div class="col-xl-12">
					<div class="card">
						<div class="card-body">
							...
							<h5 class="card-title mb-3">Görsel Sırala</h5>
							<p class="card-title-desc">
								Görselleri bu sayfadan sıralayabilirsiniz.
							</p>
							...
							<div class="card-body">
								<div class="cf nestable-lists">
									...
									<div class="dd" id="nestable">
										<ol class="dd-list">
											@foreach($gorseller as $entry)
											<li class="dd-item" data-id="{{ $entry->id }}"><div class="dd-handle"><img src="{{ $entry->gorsel }}" height="100"></div></li>
											@endforeach
										</ol>
									</div>
								</div>
							</div>
							<form action="{{ route('admin.urunGorsel.sirala', $urun->id) }}" method="post">
								@csrf
