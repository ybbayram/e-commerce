		...
		<div class="container-fluid">
			...
			<div class="row">
				...
				<div class="col-xl-12">
					<div class="card">
						<div class="card-body">  
							<h5 class="card-title mb-3">Öne Çıkar</h5>
							<p class="card-title-desc">
								Ürünleri bu sayfadan öne çıkarabilirsiniz.
							</p>
							<div id="donut-example" class="morris-charts workloed-chart" dir="ltr"> 
								<div class="card-body">
									<div class="row">
										<div class="col-6">
											<label>Başlık</label>
											<input type="text" name="baslik" class="form-control" disabled value="{{$oneCikan->baslik}}">

										</div>
										<div class="col-6">
											<label>Alt Başlık</label>
											<input type="text" name="baslik_altl" class="form-control" disabled value="{{$oneCikan->baslik_alt}}">
										</div>
									</div>
								</div>
							</div>
					...
					<div class="card">
						<div class="card-body">  
							...
							<div id="donut-example" class="morris-charts workloed-chart" dir="ltr">
								...
								<div class="card-body">
									<form method="post" action="{{route('admin.oneCikanlar.urun.ekle', $id)}}">
										@csrf
										<div class="row"> 
											<div class="col-6 mb-4">
												<label>Ürün Stok kodunu giriniz</label>
												<input multiple data-role="tagsinput" name="stok_kodlari" />
											</div>
											<div class="col-6">
												<button type="submit" style="margin-bottom:-65px;" class="btn btn-primary">Gönder</button>
											</div>
										</div>
									</form>
                        ...
                        <tr> 
                          <td>{{$entry->urun_getir['kod']}}</td>
                          <td>{{$entry->urun_getir['baslik']}}</td>
                          <td>
                              ...
                              <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body">
                                    <form action="{{ route('admin.oneCikanlar.urun.sil', $entry->id) }}" method="get">
                                      @csrf
