						...
						<div class="card-body">
							...
							<div class="row">
								...
								<div class="col-lg-12 col-sm-12 mb-4">
									<form action="{{ route('admin.oneCikanlar.olustur') }}" method="post" enctype="multipart/form-data">
										@csrf
										...
										<div class="form-group ">
											...
											<input class="form-control" name="baslik" type="text" id="example-email-input1" placeholder="Öne Çıkanlar başlığını giriniz" required="true" value="{{ old('baslik') }}">
										</div> 

										<div class="form-group ">
											<label for="example-email-input1" class="col-form-label pt-0">Alt Başlık <span style="color: red;">*</span></label>
											<input class="form-control" name="baslik_alt" type="text" id="example-email-input1" placeholder="Öne Çıkanlar alt başlığını giriniz" required="true" value="{{ old('baslik_alt') }}">
										</div> 
