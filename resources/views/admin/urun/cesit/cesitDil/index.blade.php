				...
				<div class="col-xl-12">
					<div class="card">
						<div class="card-body">
							...
							<a href="{{ route('admin.urunCesitDil.olustur.sayfa', $cesit->id) }}"><span class="btn btn-primary btn btn-xl inputTwo" style="margin-bottom: 20px">Yeni Çeşit Dili</span></span></a>
							<span class="float-right text-muted font-size-13"></span>
							<h5 class="card-title mb-3"><b>{{ $cesit->baslik }}</b> Çeşitin Dilleri</h5>
							...
							<div class="card-body">
								...
								<div class="table-responsive">
									<table id="datatable-buttons" class="table table-striped table-bordered w-100">
										...
										<tbody>
											@foreach($cesitDil as $entry)
											<tr>
												<td>{{ $entry->dil_bul['ad'] }}</td>
												<td>{{ $entry['ad'] }}</td>
												<td>{{ $entry['created_at'] }}</td>					
												<td>
													<a href="{{ route('admin.urunCesitDil.guncelle.sayfa', ['cesit' => $cesit->id, 'id' => $entry->id]) }}" title="Düzenle" data-tippy-placement="top" class="btn btn-primary waves-effect waves-light tippy-btn"><i class="dripicons-pencil"></i></a>
														...
														<div class="modal-dialog modal-dialog-centered">
															<div class="modal-content">
																...
																<div class="modal-body">
																	<form action="{{ route('admin.urunCesitDil.sil', ['cesit' => $cesit->id, 'id' => $entry->id]) }}" method="get">
																		@csrf
