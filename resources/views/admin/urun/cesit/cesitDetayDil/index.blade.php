...
@section('title', 'Çeeşit Detay Dil')
@section('css')
			...
			<div class="row">
				<div class="col-12">
					<div class="page-title-box d-flex align-items-center justify-content-between">
						<h4 class="mb-0 font-size-18">Ürün Çeşit Dil</h4>
					</div>
				</div>
			</div>
			<!-- end page title -->
				...
				<div class="col-xl-12">
					<div class="card">
						<div class="card-body">
							...
							<a href="{{ route('admin.urunCesitDetayDil.olustur.sayfa', $cesitDetay->id) }}"><span class="btn btn-primary btn btn-xl inputTwo" style="margin-bottom: 20px">Yeni Çeşit Dili</span></span></a>
							<span class="float-right text-muted font-size-13"></span>
							<h5 class="card-title mb-3"><b>{{ $cesitDetay->ad }}</b> Çeşitin Dilleri</h5>
							<p class="card-title-desc">
								Çeşit dillerine bu sayfadan ulaşabilirsiniz.
							</p>
							...
							<div class="card-body">
								...
								<div class="table-responsive">
									<table id="datatable-buttons" class="table table-striped table-bordered w-100">
										...
										<tbody>
											@foreach($cesitDetayDil as $entry)
											<tr>
												<td>{{ $entry->dil_bul['ad'] }}</td>
												<td>{{ $entry['ad'] }}</td>
												<td>{{ $entry['created_at'] }}</td>					
												<td>
													<a href="{{ route('admin.urunCesitDetayDil.guncelle.sayfa', ['cesitDetay' => $cesitDetay->id, 'id' => $entry->id]) }}" title="Düzenle" data-tippy-placement="top" class="btn btn-primary waves-effect waves-light tippy-btn"><i class="dripicons-pencil"></i></a>
														...
														<div class="modal-dialog modal-dialog-centered">
															<div class="modal-content">
																...
																<div class="modal-body">
																	<form action="{{ route('admin.urunCesitDetayDil.sil', ['cesitDetay' => $cesitDetay->id, 'id' => $entry->id]) }}" method="get">
																		@csrf
