		...
		<div class="container-fluid">
			...
			<div class="row">
				...
				<div class="col-xl-12">
					<div class="card">
						<div class="card-body"> 
							<a href="{{route('admin.xAlyOde.olustur.sayfa')}}"><span class="btn btn-primary btn btn-xl inputTwo" style="margin-bottom: 20px">Yeni X Al Y Öde Kampanyası</span></span></a>
							<span class="float-right text-muted font-size-13"></span>
							<h5 class="card-title mb-3">X Al Y Öde İndirimi</h5>
							<p class="card-title-desc">
								X Al Y Öde kampanyalarına bu sayfadan ulaşabilirsiniz.
							</p>
								...
								<div class="table-responsive">
									<table id="datatable-buttons" class="table table-striped table-bordered w-100">
										...
										<tbody> 
											...
											<tr> 
												<td>{{$entry->ad}}</td>
												<td>@if($entry->tur == 0) Yüzde @else Adet @endif</td>
												<td>{{$entry->min}}</td>
												<td>{{$entry->adet_yuzde}}@if($entry->tur == 0) % @else Adet @endif</td> 
												<td>
												...
												<td>
													<a href="{{ route('admin.xAlyOde.guncelle.sayfa', $entry->id) }}" title="Düzenle" data-tippy-placement="top" class="btn btn-primary waves-effect waves-light tippy-btn"><i class="dripicons-pencil"></i></a>
														...
														<div class="modal-dialog modal-dialog-centered">
															<div class="modal-content">
																...
																<div class="modal-body">
																	<form action="{{ route('admin.xAlyOde.sil', $entry->id) }}" method="get">
																		@csrf
