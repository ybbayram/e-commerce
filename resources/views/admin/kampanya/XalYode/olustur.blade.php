				...
				<div class="col-12">
					<div class="card">
						<div class="card-body">
							...
							<h4 class="card-title"> X al Y öde İndirimi Oluştur</h4>
							<p class="card-title-desc"> X al Y öde  indirimi oluşturunuz.</p>

							<div class="row">

								<div class="col-lg-12 col-sm-12 mb-4">
									<form action="{{route('admin.xAlyOde.olustur')}}" method="post">
										@csrf
										<div class="form-group ">
											<label for="example-email-input1" class="col-form-label pt-0">Ad</label>
											<input class="form-control" name="ad" type="text" id="example-email-input1" placeholder="Kampanya adının giriniz." required="true" value="{{ old('min') }}">
										</div>

										<div class="form-group ">
											<label for="example-email-input1" class="col-form-label pt-0">Adet Miktarı</label>
											<input class="form-control" name="min" type="number" step="any" id="example-email-input1" placeholder="Kaç adet ürüne indirim" required="true" value="{{ old('min') }}">
										</div>
										<div class="form-group " >
										...
										<div class="form-group" id="fiyat" style="display: none">
											...
											<input class="form-control" name="adet" type="number" step="any" id="example-email-input1" placeholder="İndirim tutarını giriniz"  value="{{ old('adet') }}">
										</div>
