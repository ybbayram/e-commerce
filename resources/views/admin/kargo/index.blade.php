					...
					<div class="card">
						<div class="card-body"> 
							...
							<p class="card-title-desc">
								Kargo fiyatlarına bu sayfadan ulaşabilirsiniz.
							</p>
									...
									<table id="datatable-buttons" class="table table-striped table-bordered w-100">
										...
										<tbody>
											...
											<tr>
												<td>{{ $entry['ad'] }}</td>
												<td>
													<a href="{{route('admin.kargo.fiyat.sayfa', $entry->id)}}" title="Detay" data-tippy-placement="top" class="btn btn-primary waves-effect waves-light tippy-btn"><i class="dripicons-graph-pie"></i></a> 
												</td>
											</tr>
											@endforeach
										</tbody>
