						...
						<div class="card-body">
							...
							<div class="row">
								...
								<div class="col-lg-12 col-sm-12 mb-4">
									<form action="{{ route('admin.sozlesmeDil.olustur', $sozlesme['id']) }}" method="post">
										@csrf
										...
										<div class="form-group ">
											...
											<input class="form-control" name="baslik" type="text" id="example-email-input1" placeholder="Sözleşme başlığını giriniz" required="true" value="{{ old('baslik') }}">
										</div>
										<div class="form-group ">
