			...
			<div class="row">
				<div class="col-12">
					<div class="page-title-box d-flex align-items-center justify-content-between">
						<h4 class="mb-0 font-size-18">Sözleşme Dil</h4>
					</div>
				</div>
			</div>
			<!-- end page title -->
				...
				<div class="col-xl-12">
					<div class="card">
						<div class="card-body">
							...
							<a href="{{ route('admin.sozlesmeDil.olustur.sayfa', $sozlesme->id) }}"><span class="btn btn-primary btn btn-xl inputTwo" style="margin-bottom: 20px">Yeni Sözleşme Dili</span></span></a>
							<span class="float-right text-muted font-size-13"></span>
							<h5 class="card-title mb-3"><b>{{ $sozlesme->baslik }}</b> Sözleşme Dilleri</h5>
							<p class="card-title-desc">
								Sözleşme dillerine bu sayfadan ulaşabilirsiniz.
							</p>
										...
										<tbody>
											...
											<tr>
												...
												<td>
													...
													<a href="{{ route('admin.sozlesmeDil.guncelle.sayfa', ['sozlesme' => $sozlesme->id, 'id' => $entry->id]) }}" title="Düzenle" data-tippy-placement="top" class="btn btn-primary waves-effect waves-light tippy-btn"><i class="dripicons-pencil"></i></a>
														...
														<div class="modal-dialog modal-dialog-centered">
															<div class="modal-content">
																...
																<div class="modal-body">
																	<form action="{{ route('admin.sozlesmeDil.sil', ['sozlesme' => $sozlesme->id, 'id' => $entry->id]) }}" method="get">
																		@csrf
