			...
			<div class="row">
				<div class="col-12">
					<div class="page-title-box d-flex align-items-center justify-content-between">
						<h4 class="mb-0 font-size-18">{{ $banner['ad'] }} Banner Dili Oluştur</h4>
					</div>
				</div>
			</div>
						...
						<div class="card-body">
							...
							<div class="row">
								...
								<div class="col-lg-12 col-sm-12 mb-4">
									<form action="{{ route('admin.site.bannerDil.olustur', $banner['id']) }}" method="post" enctype="multipart/form-data">
										@csrf
