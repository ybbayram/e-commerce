...
<script type="text/javascript">
  /*
  function filtreUrl(markaid = null, etiketid = null) {
    var href = window.location.href;
    if (markaid !== null) {
      var marka = href+"?m"+markaid;
      $.ajax({
        type:"GET",
        url: marka,
        success:function(){
          window.location.href = marka;
        }
      });
    }
  }
...
@section('title', $kategori->kategori_dil_getir['ad'])
@php
      ...
      <div class="col-sm-6">
        <nav aria-label="breadcrumb" class="theme-breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">{{ $kategori->kategori_dil_getir['ad'] }}</li>
          </ol>
        </nav>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-sm-3 collection-filter">
          ...
          <div class="collection-filter-block">
            ...
            <form action="{{ route('shop.kategori.filtre', $kategori->slug) }}" method="get">
              <!-- Markalar -->
              <div class="collection-collapse-block">
                ...
                <div class="collection-collapse-block-content" style="display:none;">
                  <div class="collection-brand-filter">
                    ...
                    <div class="form-check collection-filter-checkbox">
                      <input type="checkbox" id="markalar{{$entry->id}}" class="form-check-input" @if(in_array($entry->id, $gelenMarka)) checked @endif name="markalar[]" value="{{ $entry['id'] }}">
                      <label class="form-check-label mt-1" for="markalar{{ $entry['id'] }}">{{ $entry['ad'] }}</label>
                    </div>
                    @endforeach
                  </div>
                </div>
            ...
            <div class="row">
              <div class="col-sm-12">
                <div class="top-banner-wrapper">
                  <img src="{{ $kategori->kategori_dil_getir['gorsel'] }}" class="img-fluid blur-up lazyload" alt="">
                  <div class="top-banner-content small-section">
                    <h4>{{ $kategori->kategori_dil_getir['ad'] }}</h4>
                    <p>{!! $kategori->kategori_dil_getir['aciklama'] !!} </p>
                  </div>
                </div>
                <div class="collection-product-wrapper">
                  <div class="product-top-filter">
                    <div class="row">
                      <div class="col-xl-12">
                        <div class="filter-main-btn"><span class="filter-btn btn btn-theme"><i class="fa fa-filter" aria-hidden="true"></i> Filtre</span></div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-12">
                        <div class="product-filter-content">
                          ...
                          <div class="product-page-filter">
                            ...
                            <select name="filtreFiyat" id="filtreGetir" onchange="filtreFiyatgetir('{{$kategori->slug}}','{{$urlSlug}}')">
                      ...
                      <div class="col-xl-3 col-6 col-grid-box">
                        <div class="product-box">
                          <div class="img-wrapper">
                            <div class="front">
                              <a href="{{ route('urun', $entry->slug) }}"><img src="{{ $entry->urun_gorsel_bul['gorsel'] }}" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            </div>
