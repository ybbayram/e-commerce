...
@section('title', $etiket->etiket_dil_getir['ad'])
      ...
      <div class="col-sm-6">
        <nav aria-label="breadcrumb" class="theme-breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">{{ $etiket->etiket_dil_getir['ad'] }}</li>
          </ol> 
        </nav>
      </div>
    </div>
            ...
            <div class="collection-collapse-block open">
              ...
              <div class="collection-collapse-block-content">
                <div class="collection-brand-filter">
                  @foreach($kategori as $entry)
                  <div class="form-check collection-filter-checkbox">
                    <li><a style="color: black;" href="{{ route('shop.kategori', $entry['slug']) }}">{{ $entry->kategori_dil_getir['ad'] }}</a></li>
                  </div>
                  @endforeach
                </div>
              </div>
            </div>
            <form action="{{ route('shop.etiket.filtre', $etiket->slug) }}" method="get">
              <!-- Markalar -->
              <div class="collection-collapse-block  ">
                ...
                <div class="collection-collapse-block-content" style="display:none;">
                  <div class="collection-brand-filter">
                    ...
                    <div class="form-check collection-filter-checkbox">
                      <input type="checkbox" class="form-check-input" @if(in_array($entry->id, $gelenMarka)) checked @endif id="m{{ $entry['id'] }}" name="markalar[]" value="{{ $entry['id'] }}">
              ...
              <div>
                ...
                <div class="media">
                  <a href="{{ route('urun', $entry->slug) }}">
                    <img class="img-fluid blur-up lazyload" src="{{ $entry->gorsel_bul['gorsel'] }}" alt="">
                  </a>
            ...
            <div class="row">
              <div class="col-sm-12">
                    ...
                    <div class="row">
                      <div class="col-12">
                        <div class="product-filter-content">
                          ...
                          @php $urlSlug = "tag"; @endphp
                          <div class="product-page-filter">
                            <select name="filtreFiyat" id="filtreGetir" onchange="filtreFiyatgetir('{{$etiket->slug}}', '{{$urlSlug}}')">
                ...
                <div class="mt-4"> 
                  ...
                  @if($gelenMarka !== Array() )
                  {{ $urunler->appends(['markalar' => $gelenMarka , 'price_start' => $gelenBaslangicFiyat, 'price_finish' => $gelenBitisFiyat])->links() }}
                  @else
