...
g.messageTop+f+f+i);g.messageBottom&&(i=i+f+f+g.messageBottom);c.customize&&(i=c.customize(i,c,b));c=j("<textarea readonly/>").val(i).appendTo(d);if(k.queryCommandSupported("copy")){d.appendTo(b.table().container());c[0].focus();c[0].select();try{var h=k.execCommand("copy");d.remove();if(h){b.buttons.info(b.i18n("buttons.copyTitle","Tablo kopyalandı"),b.i18n("buttons.copySuccess",{1:"Copied one row to clipboard",_:"%d satır kopyalandı"},a.rows),2E3);this.processing(!1);return}}catch(n){}}h=
